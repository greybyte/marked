/**
 * marked - a markdown parser (greybyte fork)
 * Copyright (c) 2011-2014, Christopher Jeffrey. (MIT Licensed)
 * Repo: https://github.com/greybyte/marked
 * Original Repo: https://github.com/chjj/marked
 */
...
InlineLexer.prototype.output = function(src) {
  ...
  while (src) {
    ...
    if (cap = this.rules.text.exec(src)) {
      src = src.substring(cap[0].length);
      out = this.renderer.add(out, this.renderer.text(escape(this.smartypants(cap[0]))));
      continue;
    }
...
Renderer.prototype.add = function(out, fragment) {
  return out + fragment;
}
